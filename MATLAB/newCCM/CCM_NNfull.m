function [kmin,E,dev,E2] = CCM_NNfull(R_l,R_s,rho_AA,rho_BB,sigma)
...
global crystalData
     ...
     for k = 1:length(crystalData.names)
             ...
             [~,E_f1(k),~,devs(k),~,~] = CCM_NNmain(R_l,R_s,crystalData.NNarr{k},crystalData.NParr{k},crystalData.dists{k},rho_AA,rho_BB,sigma);
