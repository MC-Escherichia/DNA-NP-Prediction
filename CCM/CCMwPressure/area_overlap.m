function [overlap_array, area_total_array] = area_overlap(dna_increase,d,comp,comp_m)
% Input
...
% Compress max DNA-NP radii
rad_max_A = rad_max_A*comp_m;
rad_max_B = rad_max_B*comp_m;
% Distance between nanoparticle cores
d_NP_core_AA = (rad_A + rad_A)*d*comp;
d_NP_core_AB = (rad_A + rad_B)*d*comp;
d_NP_core_BB = (rad_B + rad_B)*d*comp;
