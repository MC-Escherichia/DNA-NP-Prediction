...
pom:
	...
	@echo "  <groupId>local</groupId>" >> pom.xml
...
jar:
	...
	@mkdir META-INF
	@mv pom.xml META-INF/
	@jar -cMf jreality-native-deps-${VERSION}.jar native lib META-INF
...
deploy: jar
	@echo "Deploying to local repo"
	@mvn install:install-file -Dfile=jreality-native-deps-${VERSION}.jar
	clean
