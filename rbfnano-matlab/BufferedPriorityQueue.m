classdef BufferedPriorityQueue < handle
    ...
    methods (Access = public)
        ...
        function obj = BufferedPriorityQueue( limit, flagMaxPriorityQueue  )
            ...
            if ~exist( 'limit', 'var' ) || ~isscalar(limit) || limit <= 0
                error( 'ERROR: invalid limit argument' );
            end
            ...
            obj.numElements = 0;
            obj.priorityList = cell(obj.limit + 1 , 1);
            obj.valueList = cell(obj.limit + 1 , 1);

        end

        function toggle(obj)
            obj.flagMaxPriorityQueue = ~obj.flagMaxPriorityQueue;
        end
